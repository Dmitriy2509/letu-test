...
public class DemoWebShopApiTest {
    ...
    @Test
    @Description("This test verifies a registered user can add phone cover to card by API")
    @DisplayName("Add phone cover to card by API")
    ...
    @Test
    @Description("This test verifies a registered user can subscribe with email by API")
    ...
    @Test
    @Description("This test verifies a registered user can send email to a friend about item in the shop by API")
    @DisplayName("Notify a friend about item in the shop with email")
